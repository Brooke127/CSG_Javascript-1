...
function setup() {
  ...
  boom1 = new Boom(1,'olive',130, 'red');
  boom2 = new Boom(5,'forestgreen',300, 'orange');
  boom3 = new Boom(3,'yellowgreen',600, 'yellow');
  boom4 = new Boom(6, 'pink', 500, 'dark green');
  boom5 = new Boom(7, 'red', 550, 'blue');
}
